...
export function AddProposalDialog() {
    ...
    // Estado global para armazenar o valor total dos produtos
    ...
    // Função para atualizar os produtos selecionados no estado do pai
    const handleServicesChange = (products: { value: string; quantity: number }[]) => {
        setSelectedServices(products);
    };
        ...
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[1200px]">
                ...
                <div className="flex gap-2">
                    ...
                    <UserPicker users={customers} />
                </div>
                <div className="grid grid-cols-2 gap-4 py-4">
                    <div className="flex gap-2 flex-col">
                        <div className="col-span-2">
                            <Textarea placeholder="Descrição" className="min-h-[254px]"  rows={3} />
                        </div>
                        <div className="col-span-2">
                    ...
                    <div>
                        ...
                        <Tabs defaultValue="products" className="w-full">
                            <TabsList className="bg-custom-background-90 p-1 flex gap-4 justify-evenly rounded-lg mb-2">
                                <TabsTrigger className="w-full p-1 rounded-md data-[state=active]:bg-custom-background-80 data-[state=active]:text-slate-50 text-slate-600 text-sm" value="products">
                                    Produtos
                                </TabsTrigger>
                                <TabsTrigger className="w-full p-1 rounded-md data-[state=active]:bg-custom-background-80 data-[state=active]:text-slate-50 text-slate-600 text-sm" value="services">
                                    Serviços
                                </TabsTrigger>
                            </TabsList>
                            {/* Aba de Produtos */}
