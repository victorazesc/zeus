...
export function AddProposalDialog({
  ...
  const dialogOpen = isControlledExternally
    ? Boolean(externalIsOpen)
    : internalOpen;
  ...
  useEffect(() => {
    if (isControlledExternally) {
      setInternalOpen(Boolean(externalIsOpen));
    }
  ...
  const resetFormState = () => {
    reset();
    setTotalPrice(0);
    setTotalProfitChange(0);
    setTotalPriceServices(0);
    setAddMore(false);
  };
    ...
    await proposalService
      ...
      .catch((error: any) =>
        toast.error("Erro ao adicionar proposta", {
          description:
            error ?? "Houve um problema ao criar a proposta. Tente novamente.",
        })
      );
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex gap-2">
            <Controller
              ...
              name="initialDate"
              render={({ field }) => (
                <DatePicker label="Data Início" {...field} />
              )}
            />
            <Controller
              control={control}
            ...
            <Controller
              ...
              render={({ field }) => (
                <StatusPicker
                  {...field}
                  value={getValues("status") as Status}
                />
              )}
            />
            <Controller
              ...
              render={({ field }) => (
                <UserPicker
                  ...
                  {...field}
                  value={getValues("user") || undefined}
                />
              )}
            />
            <Controller
              ...
              render={({ field }) => (
                <UserPicker
                  ...
                  {...field}
                  value={getValues("customer") || undefined}
                />
              )}
            />
          </div>
          <div className="grid grid-cols-2 gap-4 py-4">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <MonetaryInput
                  value={discount || 0}
                  onValueChange={(e) => setValue("discount", Number(e))}
                />
              </div>
