...
import { AddCustomerDialog } from "../customer/add/dialog";

export const ClientsHeader = observer(({ searchValue, setSearchValue }:any) => {
  return (
          ...
          <Breadcrumbs>
            <Breadcrumbs.BreadcrumbItem
              ...
              link={
                <BreadcrumbLink
                  label="Clientes"
                  icon={<UsersIcon className="h-4 w-4 text-custom-text-300" />}
                />
              }
            />
          </Breadcrumbs>
